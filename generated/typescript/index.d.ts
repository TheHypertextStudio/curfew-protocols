...
export type MCPToolRegistry = {
  ...
  remoteTools: [
    ...
    {
      name: "list_pending_remote_unlock_requests"
      description: "Lists pending remote unlock request IDs created by this exact OAuth client, in bounded pages, so an MCP App can recover cancellation after a remount."
      requiredScopes: ["curfew:unlock:request"]
      inputSchema: {type: "object"; additionalProperties: false; properties: {cursor: {type: "string"; format: "uuid"}}}
      outputSchema: {
        type: "object"
        additionalProperties: false
        properties: {
          requestIds: {type: "array"; maxItems: 32; uniqueItems: true; items: {type: "string"; format: "uuid"}}
